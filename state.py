...
APP_STATE_TYPES: dict = {
    ...
    "AnglX_Prdn": int,
    "AnglZ_Prdn": int,
    "dH1": int, "Kr1": int, "DOR1": int,
    "dH2": int, "Kr2": int, "DOR2": int,
    "dH7": int, "Kr7": int, "DOR7": int,
    "dH8": int, "Kr8": int, "DOR8": int,
    "vidDNA": str,
    "vidDOR1": str, "vidDOR2": str, "vidDOR7": str,
}
...
class AppState:
    def __init__(self):
        ...
        self.Sqw: int = 0
        self.dH1: int = 0;  self.Kr1: int = 0;  self.DOR1: int = 0
        self.dH2: int = 0;  self.Kr2: int = 0;  self.DOR2: int = 0
        self.dH7: int = 0;  self.Kr7: int = 0;  self.DOR7: int = 0
        self.dH8: int = 0;  self.Kr8: int = 0;  self.DOR8: int = 0
...
def evs(source: str):
    ...
    ctx.update({
        ...
        "sqrt": _np.sqrt,  "abs":  _np.abs,   "exp":  _np.exp,
        "log":  _np.log,   "log10":_np.log10, "pi":   _np.pi,
        "deg2rad": _np.deg2rad, "rad2deg": _np.rad2deg,
        "mean": _np.mean,  "max":  _np.max,   "min":  _np.min,
